package com.opaltrace.platform.shared.application.result;
...
public record ApplicationError(
    ...
    /**
     * Unauthorized error: authentication failed or access denied
     */
    public static ApplicationError unauthorized(String context, String reason) {
        return new ApplicationError(
                "UNAUTHORIZED_ERROR",
